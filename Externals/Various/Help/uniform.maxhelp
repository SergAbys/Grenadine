...
,
		"rect" : [ 794.0, 143.0, 319.0, 303.0 ],
		"bglocked" : 0,
		"defrect" : [ 794.0, 143.0, 319.0, 303.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p TUTO41",
					"patching_rect" : [ 25.0, 123.0, 76.0, 23.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 14.0,
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
									"midpoints" : [ 109.5, 599.0, 201.0, 599.0, 201.0, 417.0, 122.5, 417.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t 2",
					"patching_rect" : [ 145.0, 163.0, 26.0, 23.0 ],
					"outlettype" : [ "int" ],
					"fontsize" : 14.0,
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Kinda Finite State Automata  // 100",
					"frgb" : [ 0.93, 0.93, 0.97, 1.0 ],
					"patching_rect" : [ 13.0, 44.0, 231.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Uniform",
					"frgb" : [ 0.93, 0.93, 0.97, 1.0 ],
					"patching_rect" : [ 13.0, 14.0, 91.0, 30.0 ],
					"fontface" : 3,
					"textcolor" : [ 0.93, 0.93, 0.97, 1.0 ],
					"fontsize" : 20.871338,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 25.0, 263.0, 52.0, 23.0 ],
					"fontsize" : 14.0,
					"color" : [ 0.827451, 0.737255, 0.835294, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
...
,
						"rect" : [ 372.0, 216.0, 360.0, 303.0 ],
						"bglocked" : 0,
						"defrect" : [ 372.0, 216.0, 360.0, 303.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "p Y",
									"patching_rect" : [ 200.0, 220.0, 31.0, 23.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 14.0,
									"color" : [ 0.827451, 0.737255, 0.835294, 1.0 ],
									"numinlets" : 1,
...
,
										"rect" : [ 495.0, 187.0, 122.0, 394.0 ],
										"bglocked" : 0,
										"defrect" : [ 495.0, 187.0, 122.0, 394.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 14.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "pack",
													"patching_rect" : [ 20.0, 300.0, 40.0, 23.0 ],
													"outlettype" : [ "" ],
													"fontsize" : 14.0,
													"numinlets" : 2,
													"fontname" : "Arial",
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "t b i",
													"patching_rect" : [ 20.0, 200.0, 40.0, 23.0 ],
													"outlettype" : [ "bang", "int" ],
													"fontsize" : 14.0,
													"numinlets" : 1,
													"fontname" : "Arial",
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "int",
													"patching_rect" : [ 60.0, 260.0, 32.5, 23.0 ],
													"outlettype" : [ "int" ],
													"fontsize" : 14.0,
													"numinlets" : 2,
													"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "loadmess 4",
									"patching_rect" : [ 240.0, 180.0, 82.0, 23.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 14.0,
									"numinlets" : 1,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "umenu",
									"patching_rect" : [ 200.0, 140.0, 116.0, 25.0 ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "pgmout",
									"patching_rect" : [ 200.0, 260.0, 57.0, 23.0 ],
									"fontsize" : 14.0,
									"numinlets" : 2,
									"fontname" : "Arial",
									"numoutlets" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "pipe 175",
									"patching_rect" : [ 80.0, 100.0, 64.0, 23.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 14.0,
									"numinlets" : 2,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "unpack",
									"patching_rect" : [ 20.0, 60.0, 79.0, 23.0 ],
									"outlettype" : [ "int", "int" ],
									"fontsize" : 14.0,
									"numinlets" : 1,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "p",
									"patching_rect" : [ 20.0, 180.0, 32.0, 23.0 ],
									"outlettype" : [ "" ],
									"fontsize" : 14.0,
									"color" : [ 0.827451, 0.737255, 0.835294, 1.0 ],
									"numinlets" : 1,
...
,
										"rect" : [ 530.0, 355.0, 237.0, 258.0 ],
										"bglocked" : 0,
										"defrect" : [ 530.0, 355.0, 237.0, 258.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 14.0,
										"default_fontface" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "noteout",
									"patching_rect" : [ 20.0, 260.0, 130.0, 23.0 ],
									"fontsize" : 14.0,
									"color" : [ 0.501961, 0.717647, 0.764706, 1.0 ],
									"numinlets" : 3,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "makenote 90 35 1",
									"patching_rect" : [ 20.0, 220.0, 130.0, 23.0 ],
									"outlettype" : [ "float", "float", "float" ],
									"fontsize" : 14.0,
									"numinlets" : 4,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "freebang",
									"patching_rect" : [ 340.0, 140.0, 66.0, 23.0 ],
									"outlettype" : [ "bang" ],
									"fontsize" : 14.0,
									"numinlets" : 0,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "i 0",
									"patching_rect" : [ 340.0, 220.0, 36.0, 23.0 ],
									"outlettype" : [ "int" ],
									"fontsize" : 14.0,
									"numinlets" : 2,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "uzi 16 1",
									"patching_rect" : [ 340.0, 180.0, 72.0, 23.0 ],
									"outlettype" : [ "bang", "bang", "int" ],
									"fontsize" : 14.0,
									"numinlets" : 2,
									"fontname" : "Arial",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "ctlout 123",
									"patching_rect" : [ 340.0, 260.0, 72.0, 23.0 ],
									"fontsize" : 14.0,
									"numinlets" : 3,
									"fontname" : "Arial",
									"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 145.0, 88.0, 20.0, 20.0 ],
					"outlettype" : [ "int" ],
					"numinlets" : 1,
					"numoutlets" : 1,
					"id" : "obj-21"
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "metro 200",
					"patching_rect" : [ 145.0, 122.0, 74.0, 23.0 ],
					"outlettype" : [ "bang" ],
					"fontsize" : 14.0,
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "clear",
					"patching_rect" : [ 51.0, 166.0, 41.0, 21.0 ],
					"outlettype" : [ "" ],
					"fontsize" : 14.0,
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "uniform",
					"patching_rect" : [ 25.0, 223.0, 58.0, 23.0 ],
					"outlettype" : [ "list", "" ],
					"fontsize" : 14.0,
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "panel",
					"patching_rect" : [ 10.0, 10.0, 299.0, 61.0 ],
					"mode" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 154.5, 203.0, 34.5, 203.0 ]
				}
