...
,
		"rect" : [ 402.0, 268.0, 376.0, 356.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 402.0, 268.0, 376.0, 356.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 293.0, 281.0, 33.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadmess \\\\",
					"patching_rect" : [ 232.0, 179.0, 82.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"patching_rect" : [ 71.0, 227.0, 115.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 222.0, 281.0, 66.0, 23.0 ],
					"fontname" : "Arial",
					"maximum" : "<none>",
					"presentation" : 0,
					"format" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : ";\rtoto stop",
					"linecount" : 2,
					"patching_rect" : [ 83.0, 95.0, 64.0, 37.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : ";\rtoto play",
					"linecount" : 2,
					"patching_rect" : [ 15.0, 95.0, 63.0, 37.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "r toto",
					"patching_rect" : [ 174.0, 145.0, 42.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t l",
					"patching_rect" : [ 146.0, 180.0, 21.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p time",
					"patching_rect" : [ 222.0, 246.0, 49.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
,
						"rect" : [ 744.0, 123.0, 198.0, 327.0 ],
						"bglocked" : 0,
						"defrect" : [ 744.0, 123.0, 198.0, 327.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "sel stop",
									"patching_rect" : [ 100.0, 60.0, 59.0, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"numinlets" : 1,
									"numoutlets" : 2,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "r toto",
									"patching_rect" : [ 100.0, 20.0, 42.0, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"color" : [ 0.501961, 0.717647, 0.764706, 1.0 ],
									"numinlets" : 0,
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 20.0, 240.0, 121.0, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"numinlets" : 1,
									"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "- 0.",
									"patching_rect" : [ 20.0, 200.0, 44.5, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"numinlets" : 2,
									"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "cpuclock",
									"patching_rect" : [ 100.0, 140.0, 65.0, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"numinlets" : 1,
									"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "cpuclock",
									"patching_rect" : [ 20.0, 140.0, 65.0, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"numinlets" : 1,
									"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "onebang 1",
									"patching_rect" : [ 20.0, 100.0, 99.0, 23.0 ],
									"fontname" : "Arial",
									"fontsize" : 14.0,
									"numinlets" : 2,
									"numoutlets" : 2,
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-6", 0 ],
									"hidden" : 0,
									"midpoints" : [ 109.5, 178.0, 29.5, 178.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 230.0, 120.0, 68.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "recall",
					"patching_rect" : [ 230.0, 151.0, 44.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 174.0, 180.0, 41.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
,
						"rect" : [ 605.0, 188.0, 297.0, 320.0 ],
						"bglocked" : 0,
						"defrect" : [ 605.0, 188.0, 297.0, 320.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
