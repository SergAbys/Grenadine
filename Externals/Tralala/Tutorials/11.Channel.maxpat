...
,
		"rect" : [ 593.0, 283.0, 376.0, 330.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 593.0, 283.0, 376.0, 330.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "note 0 65 90 6 10",
					"numinlets" : 2,
					"patching_rect" : [ 72.0, 193.0, 119.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"gradient" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "channel 1",
					"numinlets" : 2,
					"patching_rect" : [ 219.0, 110.0, 71.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"gradient" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "channel 10",
					"numinlets" : 2,
					"patching_rect" : [ 127.0, 110.0, 79.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"gradient" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "p MIDI",
					"numinlets" : 1,
					"patching_rect" : [ 30.0, 278.0, 52.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 0,
					"fontface" : 0,
...
,
						"rect" : [ 105.0, 163.0, 414.0, 178.0 ],
						"bglocked" : 0,
						"defrect" : [ 105.0, 163.0, 414.0, 178.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "stop",
					"numinlets" : 2,
					"patching_rect" : [ 72.0, 110.0, 37.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"gradient" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "loop",
					"numinlets" : 2,
					"patching_rect" : [ 30.0, 110.0, 37.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"gradient" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "loadbang",
					"numinlets" : 1,
					"patching_rect" : [ 121.0, 234.0, 68.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"text" : "recall",
					"numinlets" : 2,
					"patching_rect" : [ 121.0, 270.0, 44.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"gradient" : 0,
...
, 			{
				"box" : 				{
					...
					"text" : "p",
					"numinlets" : 1,
					"patching_rect" : [ 30.0, 238.0, 40.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
...
,
						"rect" : [ 607.0, 263.0, 363.0, 322.0 ],
						"bglocked" : 0,
						"defrect" : [ 607.0, 263.0, 363.0, 322.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 228.5, 170.5, 39.5, 170.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 136.5, 170.5, 39.5, 170.5 ]
				}
