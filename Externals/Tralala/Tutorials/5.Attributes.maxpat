...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 181.0, 161.0, 169.0, 32.0 ],
					"mode" : 0,
					"fontname" : "Arial",
					"presentation" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "value $1",
					"patching_rect" : [ 256.0, 209.0, 63.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 176.0, 247.0, 20.0, 20.0 ],
					"presentation" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "viewtext $1",
					"patching_rect" : [ 176.0, 286.0, 81.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "cell quarter",
					"patching_rect" : [ 135.0, 209.0, 80.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "chord 1",
					"patching_rect" : [ 46.0, 209.0, 57.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 55.5, 251.0, 27.5, 251.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 265.5, 324.0, 27.5, 324.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 185.5, 324.0, 27.5, 324.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 144.5, 251.0, 27.5, 251.0 ]
				}
