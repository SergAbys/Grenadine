...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 260.0, 180.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"presentation" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "metro 250",
					"patching_rect" : [ 260.0, 140.0, 74.0, 23.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
,
						"rect" : [ 809.0, 325.0, 390.0, 323.0 ],
						"bglocked" : 0,
						"defrect" : [ 809.0, 325.0, 390.0, 323.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 269.5, 222.0, 29.5, 222.0 ]
				}
