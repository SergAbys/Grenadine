...
,
		"rect" : [ 178.0, 195.0, 375.0, 387.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 178.0, 195.0, 375.0, 387.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "reload, forget",
					"patching_rect" : [ 133.0, 141.0, 93.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t l",
					"patching_rect" : [ 28.0, 220.0, 21.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.0, 220.0, 161.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 75.0, 269.0, 52.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
,
						"rect" : [ 515.0, 345.0, 440.0, 186.0 ],
						"bglocked" : 0,
						"defrect" : [ 515.0, 345.0, 440.0, 186.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 25.0, 105.0, 134.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 254.0, 265.0, 68.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "recall",
					"patching_rect" : [ 254.0, 301.0, 44.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 69.0, 220.0, 40.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
