...
,
		"rect" : [ 155.0, 121.0, 495.0, 446.0 ],
		"bglocked" : 0,
		"defrect" : [ 155.0, 121.0, 495.0, 446.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "restore",
					"patching_rect" : [ 340.0, 60.0, 54.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "store",
					"patching_rect" : [ 260.0, 60.0, 42.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "zone 12 96 60 69",
					"patching_rect" : [ 280.0, 140.0, 119.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "rotate",
					"patching_rect" : [ 240.0, 100.0, 46.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "bpm 240",
					"patching_rect" : [ 180.0, 60.0, 65.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "0 60, 12 61, 24 62, 36 63, 48 64, 60 65, 72 66, 84 67",
					"patching_rect" : [ 60.0, 20.0, 337.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "prepend note",
					"patching_rect" : [ 60.0, 60.0, 93.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 100.0, 400.0, 52.0, 23.0 ],
					"numinlets" : 0,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 14.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 60.0, 400.0, 24.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 14.0,
...
, 			{
				"box" : 				{
					"maxclass" : "tralala",
					"patching_rect" : [ 60.0, 180.0, 334.0, 205.0 ],
					"numinlets" : 1,
					"yoffset" : 644,
					"numoutlets" : 4,
					"hcolor2" : [ 1.0, 0.74902, 0.0, 1.0 ],
					"outlettype" : [ "list", "", "", "bang" ],
					"color" : [ 0.298039, 0.235294, 0.278431, 1.0 ],
					"xoffset" : -62,
					...
					"tralala" : 					{
						"untitled" : 						{
							...
							"0" : [ "note", 0, 60, 80, 12, 0 ],
							"1" : [ "note", 12, 61, 80, 12, 0 ],
							"2" : [ "note", 24, 62, 80, 12, 0 ],
							"3" : [ "note", 36, 63, 80, 12, 0 ],
							"4" : [ "note", 48, 64, 80, 12, 0 ],
							"5" : [ "note", 60, 65, 80, 12, 0 ],
							"6" : [ "note", 72, 66, 80, 12, 0 ],
							"7" : [ "note", 84, 67, 80, 12, 0 ]
						}
