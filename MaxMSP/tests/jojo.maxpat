...
,
		"rect" : [ 73.0, 71.0, 502.0, 592.0 ],
		"bglocked" : 0,
		"defrect" : [ 73.0, 71.0, 502.0, 592.0 ],
				...
				"box" : 				{
					...
					"tralala" : 					{
						"restore" : 						{
							...
							"bpm" : [ "bpm", 240 ],
							"0" : [ "note", 0, 64, 80, 12, 0 ],
							"1" : [ "note", 24, 66, 80, 12, 0 ],
							"2" : [ "note", 48, 60, 80, 12, 0 ],
							"3" : [ "note", 72, 62, 80, 12, 0 ]
						}
,
						"current" : 						{
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b b",
					"patching_rect" : [ 120.0, 400.0, 38.0, 23.0 ],
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 14.0,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p cputimer",
					"patching_rect" : [ 120.0, 440.0, 77.0, 23.0 ],
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 14.0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 200.0, 40.0, 170.0, 21.0 ],
					"fontname" : "Arial",
					"numinlets" : 2,
					"fontsize" : 14.0,
					"numoutlets" : 1,
