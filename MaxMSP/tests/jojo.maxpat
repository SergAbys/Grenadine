...
,
		"rect" : [ 66.0, 84.0, 649.0, 488.0 ],
		"bglocked" : 0,
		"defrect" : [ 66.0, 84.0, 649.0, 488.0 ],
				...
				"box" : 				{
					...
					"tralala" : 					{
						"restore" : 						{
							...
							"5" : [ "note", 48, 62, 80, 12, 0 ],
							"7" : [ "note", 72, 64, 80, 12, 0 ],
							"0" : [ "note", 12, 66, 80, 12, 0 ],
							"2" : [ "note", 36, 60, 80, 12, 0 ],
							"4" : [ "note", 60, 62, 80, 12, 0 ],
							"6" : [ "note", 84, 64, 80, 12, 0 ]
						}
,
						"current" : 						{
							"channel" : [ "channel", 1 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "t b b",
					"patching_rect" : [ 100.0, 340.0, 38.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p cputimer",
					"patching_rect" : [ 100.0, 380.0, 77.0, 23.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
