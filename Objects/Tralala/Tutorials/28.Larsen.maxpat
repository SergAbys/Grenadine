...
,
		"rect" : [ 245.0, 137.0, 375.0, 363.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 245.0, 137.0, 375.0, 363.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "zoulou",
					"patching_rect" : [ 140.0, 177.0, 52.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 97.0, 100.0, 37.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 123.0, 218.0, 42.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
,
						"rect" : [ 918.0, 191.0, 300.0, 328.0 ],
						"bglocked" : 0,
						"defrect" : [ 918.0, 191.0, 300.0, 328.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 135.0, 81.0, 68.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "recall",
					"patching_rect" : [ 135.0, 121.0, 44.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 65.0, 251.0, 52.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 72.0, 172.0, 42.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
,
						"rect" : [ 654.0, 150.0, 296.0, 332.0 ],
						"bglocked" : 0,
						"defrect" : [ 654.0, 150.0, 296.0, 332.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 113.0, 320.0, 21.0, 287.0, 41.0, 144.0 ]
				}
