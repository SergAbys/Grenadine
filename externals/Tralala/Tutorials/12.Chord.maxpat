...
,
		"rect" : [ 88.0, 104.0, 375.0, 387.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 88.0, 104.0, 375.0, 387.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "chord 2",
					"patching_rect" : [ 140.0, 165.0, 57.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "chord 1",
					"patching_rect" : [ 124.0, 138.0, 57.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "chord 0",
					"patching_rect" : [ 152.0, 194.0, 57.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 55.0, 271.0, 52.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 0,
...
,
						"rect" : [ 106.0, 163.0, 440.0, 186.0 ],
						"bglocked" : 0,
						"defrect" : [ 106.0, 163.0, 440.0, 186.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 80.0, 120.0, 37.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "loop",
					"patching_rect" : [ 29.0, 116.0, 37.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 134.0, 294.0, 68.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "recall",
					"patching_rect" : [ 134.0, 330.0, 44.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 55.0, 236.0, 40.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
,
						"rect" : [ 421.0, 156.0, 362.0, 324.0 ],
						"bglocked" : 0,
						"defrect" : [ 421.0, 156.0, 362.0, 324.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
								...
								"box" : 								{
									...
									"tralala" : 									{
										"untitled" : 										{
											...
											"8" : [ "note", 0, 65, 80, 6, 0 ],
											"9" : [ "note", 12, 65, 80, 6, 0 ],
											"10" : [ "note", 36, 60, 60, 6, 0 ],
											"11" : [ "note", 48, 60, 60, 6, 0 ],
											"13" : [ "note", 60, 69, 80, 6, 0 ],
											"14" : [ "note", 84, 65, 80, 6, 0 ],
											"15" : [ "note", 24, 65, 80, 6, 0 ],
											"16" : [ "note", 60, 65, 80, 6, 0 ],
											"17" : [ "note", 60, 60, 60, 6, 0 ],
											"19" : [ "note", 72, 69, 80, 6, 0 ],
											"20" : [ "note", 0, 69, 80, 6, 0 ],
											"21" : [ "note", 84, 69, 80, 6, 0 ],
											"22" : [ "note", 36, 69, 80, 6, 0 ],
											"23" : [ "note", 72, 65, 80, 6, 0 ],
											"24" : [ "note", 36, 65, 80, 6, 0 ],
											"25" : [ "note", 84, 60, 60, 6, 0 ],
											"30" : [ "note", 48, 69, 80, 6, 0 ],
											"31" : [ "note", 12, 69, 80, 6, 0 ],
											"bpm" : [ "bpm", 240 ],
											"chance" : [ "chance", 100 ],
											"velocity" : [ "velocity", 0 ],
											"channel" : [ "channel", 1 ],
