...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "toggle",
					"patching_rect" : [ 162.0, 179.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"presentation" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "mute $1",
					"patching_rect" : [ 162.0, 213.0, 61.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 136.0, 110.0, 50.0, 23.0 ],
					"triscale" : 1.0,
					"numinlets" : 1,
					"fontname" : "Arial",
					"presentation" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "velocity $1",
					"patching_rect" : [ 136.0, 146.0, 77.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 75.0, 295.0, 52.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 85.0, 146.0, 37.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "loop",
					"patching_rect" : [ 39.0, 123.0, 37.0, 21.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 75.0, 255.0, 40.0, 23.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"presentation" : 0,
					"numoutlets" : 1,
...
,
						"rect" : [ 607.0, 263.0, 359.0, 325.0 ],
						"bglocked" : 0,
						"defrect" : [ 607.0, 263.0, 359.0, 325.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
