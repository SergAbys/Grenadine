...
,
		"rect" : [ 126.0, 116.0, 375.0, 363.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 126.0, 116.0, 375.0, 363.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "zone 0 96 C3 F3",
					"patching_rect" : [ 133.0, 163.0, 114.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "zone 0 96 64 71",
					"patching_rect" : [ 117.0, 126.0, 111.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 140.0, 228.0, 68.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "recall",
					"patching_rect" : [ 140.0, 268.0, 44.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 80.0, 100.0, 37.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "loop",
					"patching_rect" : [ 20.0, 140.0, 37.0, 21.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"gradient" : 0,
					"fontface" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p MIDI",
					"patching_rect" : [ 83.0, 300.0, 52.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p",
					"patching_rect" : [ 59.0, 225.0, 42.0, 23.0 ],
					"fontname" : "Arial",
					"presentation" : 0,
					"fontface" : 0,
					"background" : 0,
...
,
						"rect" : [ 588.0, 131.0, 294.0, 328.0 ],
						"bglocked" : 0,
						"defrect" : [ 588.0, 131.0, 294.0, 328.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
