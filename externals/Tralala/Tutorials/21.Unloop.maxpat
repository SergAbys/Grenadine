...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "loop",
					"patching_rect" : [ 160.0, 200.0, 37.0, 21.0 ],
					"outlettype" : [ "" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-6",
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 160.0, 100.0, 20.0, 20.0 ],
					"outlettype" : [ "bang" ],
					"presentation" : 0,
					"id" : "obj-19",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "unloop",
					"patching_rect" : [ 200.0, 200.0, 53.0, 21.0 ],
					"outlettype" : [ "" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-11",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "delay 250",
					"patching_rect" : [ 200.0, 140.0, 71.0, 23.0 ],
					"outlettype" : [ "bang" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "stop",
					"patching_rect" : [ 60.0, 200.0, 37.0, 21.0 ],
					"outlettype" : [ "" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-5",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "delay 250",
					"patching_rect" : [ 60.0, 140.0, 71.0, 23.0 ],
					"outlettype" : [ "bang" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "loadbang",
					"patching_rect" : [ 220.0, 280.0, 68.0, 23.0 ],
					"outlettype" : [ "bang" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-2",
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "recall",
					"patching_rect" : [ 220.0, 320.0, 44.0, 21.0 ],
					"outlettype" : [ "" ],
					"presentation" : 0,
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"id" : "obj-15",
...
,
						"rect" : [ 338.0, 303.0, 295.0, 323.0 ],
						"bglocked" : 0,
						"defrect" : [ 338.0, 303.0, 295.0, 323.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 14.0,
						"default_fontface" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 169.5, 236.0, 29.5, 236.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 69.5, 236.0, 29.5, 236.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 0.694118, 0.694118, 0.694118, 1.0 ],
					"midpoints" : [ 209.5, 236.0, 29.5, 236.0 ]
				}
